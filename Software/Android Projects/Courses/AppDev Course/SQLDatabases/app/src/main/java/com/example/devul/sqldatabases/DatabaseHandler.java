...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void addContact(Phone contact) {
        ...
        values.put(KEY_PH_NO, contact.getNumber()); // Contact Phone Number
    ...
    public List<Phone> getAllContacts() {
        List<Phone> contactList = new ArrayList<Phone>();
        // Select All Query
        String selectQuery = "SELECT  * FROM " + TABLE_CONTACTS.trim();
