...
import com.devul.GPAMapper.app.Other.MainActivity;
...
public class SubjectsViewer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subjects_viewer);

        simpleFrameLayout = findViewById(R.id.frame2);
        tabLayout = findViewById(R.id.simpleTabLayout);
        prefs = SubjectsViewer.this.getSharedPreferences("prefs", MODE_PRIVATE);
        ...
        ft.replace(R.id.frame2, new SubjectsListView());
        ...
        tabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()) {
                    case 0:
                        fragment = new SubjectsListView();
                        break;
                    case 1:
                        fragment = new SubjectsGraphView();
                        break;
                }
    ...
    private void setNavigationDrawer() {
        ...
        toolbar.setTitle("Your Subjects");
        ...
        navView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if (itemId == R.id.mainPage_item) {
                    ...
                    startActivity(new Intent(SubjectsViewer.this, DataInitializer.class));
                }
                if (itemId == R.id.scores_item) {
                    tabLayout.setVisibility(View.GONE);
                    startActivity(new Intent(SubjectsViewer.this, SubjectsViewer.class));
                }
                ...
                if (itemId == R.id.settings) {
                    tabLayout.setVisibility(View.GONE);
                    startActivity(new Intent(SubjectsViewer.this, AppSettings.class));
                }
                if (frag != null) {
